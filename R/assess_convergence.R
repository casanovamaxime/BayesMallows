...
trace_alpha <- function(m, clusters){
  ...
  p <- ggplot2::ggplot(m, ggplot2::aes(x = .data$iteration, y = .data$value))+ggplot2::theme_bw(base_size = 17) +
...
trace_rho <- function(model_fit, items, clusters = model_fit$n_clusters > 1){
  ...
  p <- ggplot2::ggplot(df, ggplot2::aes(x = .data$iteration, y = .data$value, color = .data$item))+ggplot2::theme_bw(base_size = 17)  +
...
trace_rtilde <- function(model_fit, items, assessors, ...){
  ...
  ggplot2::ggplot(df, ggplot2::aes(x = .data$iteration, y = .data$value, color = .data$item))+ggplot2::theme_bw(base_size = 17) +
    ggplot2::geom_line(size = 1.2) +
...
trace_cluster_probs <- function(m){
  ...
  ggplot2::ggplot(m, ggplot2::aes(x = .data$iteration, y = .data$value,
                               color = .data$cluster))+ggplot2::theme_bw(base_size = 17) +
    ggplot2::geom_line(size = 1.2) +
    ggplot2::theme(legend.position = "none") +
    ggplot2::xlab("Iteration") +
...
trace_theta <- function(model_fit){
  ...
  p <- ggplot2::ggplot(model_fit$theta, ggplot2::aes(x = .data$iteration, y = .data$value))+ggplot2::theme_bw(base_size = 17) +
    ggplot2::xlab("Iteration") +
